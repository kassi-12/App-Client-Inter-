...
async function submitStock() {
    ...
    try {
        const response = await eel.add_stock(itemName, quantity, unit, price)();
        if (response) {
...
async function updateStockItem(id) {
    ...
    try {
        const response = await eel.update_stock(id, itemName, quantity, unit, price)();
        if (response) {
...
async function deleteStockItem(id) {
    if (confirm('Are you sure you want to delete this stock item?')) {
        try {
            const response = await eel.delete_stock(id)();
            if (response) {
...
async function adjustStockQuantity(id, currentQuantity, adjustment) {
    ...
    try {
        const response = await eel.update_stock(id, itemName, newQuantity, unit, price)();
        if (response) {
